...
library.py
==========
Standard ligand library for molbuilder.
Each entry: name -> {smiles, donors, charge, denticity, donor_atoms}
"""

# donor_atoms: list of element symbols of the donor atoms (for bond-length lookup)
LIGAND_LIBRARY = {
    # ----- Monodentate neutral -----
    ...
    "DMSO":    {"smiles": "CS(=O)C",    "donors": [1], "charge": 0, "denticity": 1, "donor_atoms": ["S"]},
    "NO":      {"smiles": "[N]=O",      "donors": [0], "charge": 1, "denticity": 1, "donor_atoms": ["N"]},  # linear NO+
    # ----- Monodentate anionic -----
    ...
    "O":       {"smiles": "[O-2]",      "donors": [0], "charge": -2, "denticity": 1, "donor_atoms": ["O"]},
    ...
    "ONO":     {"smiles": "[O-]N=O",    "donors": [0], "charge": -1, "denticity": 1, "donor_atoms": ["O"]},  # nitrito-O
    ...
    "Et":      {"smiles": "[CH2-]C",    "donors": [0], "charge": -1, "denticity": 1, "donor_atoms": ["C"]},
    ...
    # ----- Hexadentate -----
    "EDTA":    {"smiles": "[N](CC[N](CC(=O)[O-])CC(=O)[O-])(CC(=O)[O-])CC(=O)[O-]", "donors": [0, 2, 5, 10, 15, 20], "charge": -4, "denticity": 6, "donor_atoms": ["N", "N", "O", "O", "O", "O"]},
    # ----- Cyclopentadienyl -----
...
def get_ligand(name: str) -> dict:
    ...
    raise KeyError(
        f"Unknown ligand '{name}'. Available ligands:\n  {available}\n"
